...
| V3 | 新文本阅读器灰度可用 | 未开始 | 0% | `reader-core-modernization-v3-renderer-node-2026-06-20.md` |
| V4 | 交互闭环 | 未开始 | 0% | `reader-core-modernization-v4-interaction-node-2026-06-20.md` |
...
- [ ] V3 才是第一个用户可感知节点：debug/dev 可打开新文本阅读器。
- [ ] V4 让新阅读器真正可用：选择、标注、书签、搜索、朗读共享 layout position。
...
- [ ] V2-P7：补 diagnostics UI、样本 smoke 和性能基线。
