...
void main() {
  group('ReaderPagedViewportTransitionResolver', () {
    ...
    test('falls back to decorated static page when transition indices are invalid', () {
      final plan = resolver.resolve(
        requestedAnimationStyle: ReaderPageAnimationStyle.fade,
        pageCount: 8,
        currentPageIndex: 2,
  ...
  group('ReaderPagedPageFrame', () {
    testWidgets('renders frame sections and optional decoration', (tester) async {
  ...
  group('ReaderPagedViewportTransitionStack', () {
        ...
        Directionality(
          ...
          child: ReaderPagedViewportTransitionStack(
            ...
            pageBuilder: ({
              ...
              'page $pageIndex / $includeBackgroundDecoration',
            ),
    ...
    testWidgets('wraps curl transition with disabled selection', (tester) async {
      const resolver = ReaderPagedViewportTransitionResolver();
