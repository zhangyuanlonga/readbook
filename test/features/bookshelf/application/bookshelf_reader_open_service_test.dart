...
void main() {
  ...
  group('BookshelfReaderOpenService', () {
    ...
    test(
      'prefers persisted reading progress when it matches the book',
      () async {
    ...
    test(
      'uses toc snapshot before remote fallback when no progress exists',
      () async {
    ...
    test(
      'uses first local chapter meta instead of full chapter list',
      () async {
        ...
        localBookRepository
            .chapterMetaByIndex['${book.bookId}|0'] = LocalChapter(
          id: 'local_chapter_1',
          bookId: book.bookId,
          chapterIndex: 0,
          title: '本地第一章',
    ...
    test(
      'keeps txt non-ready local books on reader fallback and starts indexing',
      () async {
