...
enum AppBaseColorSchemeId {
  ...
  monoBlue('mono-blue', '黑白蓝', Color(0xFF1F5F99)),
  inkGreen('ink-green', '黑白绿', Color(0xFF2F7652)),
...
ColorScheme buildAppBaseLightColorScheme(AppBaseColorSchemeId id) {
  return switch (id) {
    ...
    AppBaseColorSchemeId.monoBlue => _buildNeutralLightColorScheme(
      primary: const Color(0xFF1F5F99),
      primaryContainer: const Color(0xFFD9E9FF),
      secondary: const Color(0xFF38698C),
      secondaryContainer: const Color(0xFFDDECF8),
      tertiary: const Color(0xFF5B6F91),
      tertiaryContainer: const Color(0xFFE4EAF7),
    ).copyWith(
      surface: const Color(0xFFFBFDFF),
      surfaceContainerLowest: const Color(0xFFFFFFFF),
      surfaceContainerLow: const Color(0xFFF1F7FF),
      surfaceContainer: const Color(0xFFE7F0FA),
      surfaceContainerHigh: const Color(0xFFDDEAF7),
      surfaceContainerHighest: const Color(0xFFD0E0F0),
      onSurface: const Color(0xFF172033),
      onSurfaceVariant: const Color(0xFF52647A),
      outline: const Color(0xFFB8C7D8),
      outlineVariant: const Color(0xFFCFDAE8),
    ),
    AppBaseColorSchemeId.inkGreen => _buildNeutralLightColorScheme(
      primary: const Color(0xFF2F7652),
      primaryContainer: const Color(0xFFD9F0E2),
      secondary: const Color(0xFF4F725E),
      secondaryContainer: const Color(0xFFDDEEE3),
      tertiary: const Color(0xFF4B7D72),
      tertiaryContainer: const Color(0xFFDDF1EC),
    ).copyWith(
      surface: const Color(0xFFFBFEFC),
      surfaceContainerLowest: const Color(0xFFFFFFFF),
      surfaceContainerLow: const Color(0xFFF0F8F3),
      surfaceContainer: const Color(0xFFE4F0E8),
      surfaceContainerHigh: const Color(0xFFD8E8DD),
      surfaceContainerHighest: const Color(0xFFCBDCCF),
      onSurface: const Color(0xFF17251B),
      onSurfaceVariant: const Color(0xFF536A5E),
      outline: const Color(0xFFB8CABA),
      outlineVariant: const Color(0xFFCEDDD4),
    ),
...
ColorScheme buildAppBaseDarkColorScheme(AppBaseColorSchemeId id) {
  return switch (id) {
    ...
    AppBaseColorSchemeId.monoBlue => _buildNeutralDarkColorScheme(
      primary: const Color(0xFFA9D0FF),
      primaryContainer: const Color(0xFF1E4672),
      secondary: const Color(0xFFAFC7DE),
      secondaryContainer: const Color(0xFF263A4F),
      tertiary: const Color(0xFFBFC7F2),
      tertiaryContainer: const Color(0xFF303653),
    ).copyWith(
      surface: const Color(0xFF101722),
      surfaceContainerLowest: const Color(0xFF0A1018),
      surfaceContainerLow: const Color(0xFF141D2A),
      surfaceContainer: const Color(0xFF192435),
      surfaceContainerHigh: const Color(0xFF203047),
      surfaceContainerHighest: const Color(0xFF293A54),
      onSurface: const Color(0xFFEAF1FA),
      onSurfaceVariant: const Color(0xFFB7C6D8),
      outline: const Color(0xFF53677E),
      outlineVariant: const Color(0xFF28384C),
    ),
    AppBaseColorSchemeId.inkGreen => _buildNeutralDarkColorScheme(
      primary: const Color(0xFF9ED9B7),
      primaryContainer: const Color(0xFF1F5137),
      secondary: const Color(0xFFB6D0BF),
      secondaryContainer: const Color(0xFF284533),
      tertiary: const Color(0xFFA7D8CD),
      tertiaryContainer: const Color(0xFF214E45),
    ).copyWith(
      surface: const Color(0xFF101913),
      surfaceContainerLowest: const Color(0xFF0A110D),
      surfaceContainerLow: const Color(0xFF142017),
      surfaceContainer: const Color(0xFF1A2A20),
      surfaceContainerHigh: const Color(0xFF213529),
      surfaceContainerHighest: const Color(0xFF2A4234),
      onSurface: const Color(0xFFEAF4EC),
      onSurfaceVariant: const Color(0xFFB8CBBE),
      outline: const Color(0xFF526A59),
      outlineVariant: const Color(0xFF2A3E31),
    ),
