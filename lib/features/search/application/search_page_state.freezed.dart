...
class _SearchPageState implements SearchPageState {
  const _SearchPageState({this.isSearching = false, this.isLoadingServerSourceCount = false, this.searchSessionId = 0, this.searchContentMode = SearchContentMode.novel, this.isPreciseBookMatch = false, this.aggregateByTitleAuthorEnabled = true, this.availableServerSourceCount = 0, final  Set<String> selectedServerSourceIds = const <String>{}, this.isAppendingResults = false, final  Map<String, BookDisplayState> bookPresentationByTargetKey = const <String, BookDisplayState>{}, this.pendingProgressReport, this.lastProgressUiUpdateAt, this.isListScrollActive = false, this.deferredProgressUiUpdate, this.pendingSearchCompletionSessionId, this.pendingSearchCompletionToken, this.isCheckingOnlineSearchAccess = true, this.hasOnlineSearchAccess = false, this.onlineSearchAccessMessage, this.onlineSearchAccessRequestId = 0, final  List<String> searchHistory = const <String>[]}): _selectedServerSourceIds = selectedServerSourceIds,_bookPresentationByTargetKey = bookPresentationByTargetKey,_searchHistory = searchHistory;
