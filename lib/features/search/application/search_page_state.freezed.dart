...
as Set<String>,selectedServerGroupNames: null == selectedServerGroupNames ? _self.selectedServerGroupNames : selectedServerGroupNames // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _SearchPageState() when $default != null:
return $default(_that.isSearching,_that.isLoadingServerSourceCount,_that.searchSessionId,_that.searchContentMode,_that.isPreciseBookMatch,_that.aggregateByTitleAuthorEnabled,_that.availableServerSourceCount,_that.selectedServerSourceIds,_that.selectedServerGroupNames,_that.isAppendingResults,_that.bookPresentationByTargetKey,_that.pendingProgressReport,_that.lastProgressUiUpdateAt,_that.isListScrollActive,_that.deferredProgressUiUpdate,_that.pendingSearchCompletionSessionId,_that.pendingSearchCompletionToken,_that.isCheckingOnlineSearchAccess,_that.hasOnlineSearchAccess,_that.onlineSearchAccessMessage,_that.onlineSearchAccessRequestId,_that.searchHistory);case _:
  return orElse();
...
class _SearchPageState implements SearchPageState {
  const _SearchPageState({this.isSearching = false, this.isLoadingServerSourceCount = false, this.searchSessionId = 0, this.searchContentMode = SearchContentMode.novel, this.isPreciseBookMatch = false, this.aggregateByTitleAuthorEnabled = true, this.availableServerSourceCount = 0, final  Set<String> selectedServerSourceIds = const <String>{}, final  Set<String> selectedServerGroupNames = const <String>{}, this.isAppendingResults = false, final  Map<String, BookDisplayState> bookPresentationByTargetKey = const <String, BookDisplayState>{}, this.pendingProgressReport, this.lastProgressUiUpdateAt, this.isListScrollActive = false, this.deferredProgressUiUpdate, this.pendingSearchCompletionSessionId, this.pendingSearchCompletionToken, this.isCheckingOnlineSearchAccess = false, this.hasOnlineSearchAccess = true, this.onlineSearchAccessMessage, this.onlineSearchAccessRequestId = 0, final  List<String> searchHistory = const <String>[]}): _selectedServerSourceIds = selectedServerSourceIds,_selectedServerGroupNames = selectedServerGroupNames,_bookPresentationByTargetKey = bookPresentationByTargetKey,_searchHistory = searchHistory;
...
@override@JsonKey() Set<String> get selectedServerSourceIds {
 ...
 final  Set<String> _selectedServerGroupNames;
@override@JsonKey() Set<String> get selectedServerGroupNames {
  if (_selectedServerGroupNames is EqualUnmodifiableSetView) return _selectedServerGroupNames;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableSetView(_selectedServerGroupNames);
}
...
as Set<String>,selectedServerGroupNames: null == selectedServerGroupNames ? _self._selectedServerGroupNames : selectedServerGroupNames // ignore: cast_nullable_to_non_nullable
as Set<String>,isAppendingResults: null == isAppendingResults ? _self.isAppendingResults : isAppendingResults // ignore: cast_nullable_to_non_nullable
