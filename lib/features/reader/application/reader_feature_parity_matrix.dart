...
class ReaderFeatureParityMatrix {
  ...
  v7CoreItems = <ReaderFeatureParityItem>[
    ReaderFeatureParityItem(
      ...
      releaseStatus: ReaderFeatureParityStatus.available,
      notes: '新旧 renderer 共用 ReaderNavigationCommand 与 page index runtime。',
    ),
    ReaderFeatureParityItem(
    ...
    ReaderFeatureParityItem(
      ...
      legacyStatus: ReaderFeatureParityStatus.available,
      releaseStatus: ReaderFeatureParityStatus.available,
      notes: '新 renderer 使用 layout hit-test 选择词，并桥接旧 selection toolbar。',
    ),
    ReaderFeatureParityItem(
    ...
    ReaderFeatureParityItem(
      ...
      legacyStatus: ReaderFeatureParityStatus.available,
      releaseStatus: ReaderFeatureParityStatus.available,
      notes: 'ReaderLayoutTextAnnotationRange 已承接旧 bookmark 样式字段。',
    ),
    ReaderFeatureParityItem(
      ...
      legacyStatus: ReaderFeatureParityStatus.available,
      releaseStatus: ReaderFeatureParityStatus.partial,
      notes: '长按/选择重叠可恢复旧工具条，直接点击现有标注仍待独立 hit-test。',
    ),
    ReaderFeatureParityItem(
    ...
    ReaderFeatureParityItem(
      ...
      legacyStatus: ReaderFeatureParityStatus.available,
      releaseStatus: ReaderFeatureParityStatus.partial,
      notes: '旧自动阅读可用，新 renderer 下手动打断、恢复、跨章仍待补齐。',
    ),
    ReaderFeatureParityItem(
    ...
    ReaderFeatureParityItem(
      ...
      legacyStatus: ReaderFeatureParityStatus.partial,
      releaseStatus: ReaderFeatureParityStatus.partial,
