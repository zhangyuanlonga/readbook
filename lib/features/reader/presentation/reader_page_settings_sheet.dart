                        ...
                        return <Widget>[
                          buildCompactSettingsCard([
                            Row(
                              children: [
                                Expanded(
                                  child: buildCompactSectionTitle('正文边距'),
                                ),
                                TextButton.icon(
                                  onPressed: () {
                                    setModalState(() {
                          ...
                          buildCompactSettingsCard([
                            Row(
                              children: [
                                Expanded(
                                  child: buildCompactSectionTitle('阅读排版'),
                                ),
                                TextButton.icon(
                                  onPressed: () {
                                    setModalState(() {
                            ...
                            buildTypographySliderRow(
                              ...
                              onChanged: (value) {
                                setModalState(() {
                                  draft = draft.copyWith(
                                    letterSpacing:
                                        _letterSpacingFromSliderValue(value),
                                  );
                                });
                              },
                            ),
                            ...
                            buildTypographySliderRow(
                              ...
                              divisions: 4,
                              value:
                                  draft.paragraphIndent.clamp(0, 4).toDouble(),
                              step: 1,
                          ...
                          buildCompactSettingsCard([
                            Row(
                              children: [
                                Expanded(
                                  child: buildCompactSectionTitle('章节头'),
                                ),
                                TextButton.icon(
                                  onPressed: () {
                                    setModalState(() {
                        ...
                        'info' => <Widget>[
                          buildCompactSettingsCard([
                            ...
                            Row(
                              children: [
                                Expanded(
                                  child: buildCompactSectionTitle('页脚边距'),
                                ),
                                TextButton.icon(
                                  onPressed: () {
