                        ...
                        : <Widget>[
                          ...
                          buildSettingsGroupEntryCard(
                            ...
                            onTap:
                                () => setModalState(() {
                                  activeSettingsGroupKey =
                                      isMangaChapter ? 'manga' : 'auto_read';
                                }),
                          ),
                        ],
                    ...
                    buildCompactSettingsCard([
                        ...
                        children: ReaderMangaReadMode.values
                            .map(
                              (mode) => ChoiceChip(
                                ...
                                onSelected: (_) {
                                  setModalState(() {
                                    draft = draft.copyWith(mangaReadMode: mode);
                                  });
                                },
                              ),
                            )
                        ...
                        children: const [0.0, 4.0, 8.0, 12.0, 16.0]
                            .map(
                              (value) => ChoiceChip(
                                ...
                                selected:
                                    (draft.mangaImagePadding - value).abs() <
                                    0.2,
                                onSelected: (_) {
                                  setModalState(() {
                                    draft = draft.copyWith(
                        ...
                        children: const [0.0, 6.0, 10.0, 14.0, 18.0]
                            .map(
                              (value) => ChoiceChip(
                                label: Text('${value.toInt()}'),
                                selected:
                                    (draft.mangaImageSpacing - value).abs() <
                                    0.2,
                                onSelected: (_) {
                                  setModalState(() {
                                    draft = draft.copyWith(
                      ...
                      Wrap(
                        ...
                        children: ReaderMangaLoadStrategy.values
                            .map(
                              (strategy) => ChoiceChip(
                                label: Text(_mangaLoadStrategyLabel(strategy)),
                                selected: draft.mangaLoadStrategy == strategy,
                                onSelected: (_) {
                                  setModalState(() {
                                    draft = draft.copyWith(
